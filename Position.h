...
public:
   ...
   {
       Position result;
       double metersX = getMetersX() + rhs.getMetersX();
       double metersY = getMetersY() + rhs.getMetersY();
       result.setMetersX(metersX);
       result.setMetersY(metersY);
       return result;
   }
   ...
   void apply(const Acceleration& acceleration, const Velocity& velocity, double time);
